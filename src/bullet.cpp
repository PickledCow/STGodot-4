...
void Bullet::set_magnet_id(int value) {
    magnet_id = value;
}
...
void Bullet::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("get_magnet_id"), &Bullet::get_magnet_id);
    ClassDB::bind_method(D_METHOD("set_magnet_id", "p_magnet_id"), &Bullet::set_magnet_id);
    ADD_PROPERTY(PropertyInfo(Variant::INT, "magnet_id"), "set_magnet_id", "get_magnet_id");
